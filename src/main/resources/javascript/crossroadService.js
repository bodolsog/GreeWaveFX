 ...
 */
function directionsServiceWaypointsOptions(latLng, waypoints) {
    return {
        origin: latLng,
        destination: latLng,
        waypoints: waypoints,
...
function findCrossroadPropereties(marker) {
    ...
    directionsService.route(
        directionsServiceWaypointsOptions(startEndClickPoint, clickWaypoints), function (response, status) {
            if (status === google.maps.DirectionsStatus.OK) {
                ...
                directionsService.route(
                    directionsServiceWaypointsOptions(startEndPoint, waypoints), function (response, status) {
                        if (status === google.maps.DirectionsStatus.OK) {
